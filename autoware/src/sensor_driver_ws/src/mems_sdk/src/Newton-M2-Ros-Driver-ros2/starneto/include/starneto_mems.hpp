...
#include "starneto_ros_msgs/msg/pos320_nav.hpp"
...
class Starneto {
 ...
 public:
  ...
  // Constructor
  Starneto(rclcpp::Node::SharedPtr &nodeHandle);
 ...
 private:
  ...
  serial::Serial ser;
  starneto_ros_msgs::msg::Gpfpd gnss;
  starneto_ros_msgs::msg::Gtimu imu;
  // Publisher
  rclcpp::Publisher<starneto_ros_msgs::msg::Gpfpd>::SharedPtr pub_gpfpd;
  rclcpp::Publisher<starneto_ros_msgs::msg::Gtimu>::SharedPtr pub_gtimu;
};
